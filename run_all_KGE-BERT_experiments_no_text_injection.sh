...
EXPERIMENTS=("airbnb__bert_all_meta_norm_hot_encoding" "airbnb__bert_all_meta_norm" "airbnb__bert_hot_encoding")
...
CACHE_ENABLED="True" ## speed-up the training only for KGE-BERT experiments
