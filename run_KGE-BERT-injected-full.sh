...
SEQ_LENGTH=512 ## mak num tokens in sentence (max 512)
...
# "airbnb__bert_ext_all_meta_norm_hot_encoding": "(6) KGE-BERT-injected-full",
# "airbnb__bert_all_meta_norm_hot_encoding": "(5) KGE-BERT-full",
# "airbnb__bert_all_meta_norm": "(3) KGE-BERT-num",
# "airbnb__bert_hot_encoding": "(4) KGE-BERT-1hot",
# "airbnb__bert": "(1) BERT",
# "airbnb__linear_all_meta_hot_encoding": "(0) LOGISTIC REGRESSION",
# "airbnb__bert_ext_v2": "(2) BERT-injected",
EXPERIMENTS=("airbnb__bert_ext_all_meta_norm_hot_encoding")
...
VECTORTYPE="embedded_in_text_v2_tao_lt_all_meta_145"
...
EXTENDED_DESCRIPTION="_extended_tao_meta_lt_v2"
...
CACHE_ENABLED="True" ## speed-up the training
